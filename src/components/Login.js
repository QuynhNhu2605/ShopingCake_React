...
function Login() {
    ...
    // Kiểm tra xem người dùng đã đăng nhập hay chưa ngay khi component được mount
    useEffect(() => {
                            ...
                            <div class="row g-0" style={{ height: "500px" }}>
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/img1.webp"
                                        alt="login form" class="img-fluid" style={{ borderRadius: "1rem 0 0 1rem", height: "500px" }} />
                                </div>
